...
if flag_IMU_13 == 1 % IMU 13 active
    ...
    [q_e_b_CF_IMU_13, w_bias_IMU_13, norm_acc13, norm_mag13, error_mag13, error_acc13, count13_1, count13_2, count13_3] = Attitude_Estimation_IECF(Acc_IMU_13, Gyro_IMU_13, Mag_cal_IMU_13);
...
if flag_IMU_14 == 1 % IMU 14 active
    % Obtain the sensor attitude estimation
    [q_e_b_CF_IMU_14, w_bias_IMU_14, norm_acc14, norm_mag14, error_mag14, error_acc14, count14_1, count14_2, count14_3] = Attitude_Estimation_IECF(Acc_IMU_14, Gyro_IMU_14, Mag_cal_IMU_14);
...
if flag_IMU_15 == 1 % IMU 15 active
    % Obtain the sensor attitude estimation
    [q_e_b_CF_IMU_15, w_bias_IMU_15, norm_acc15, norm_mag15, error_mag15, error_acc15, count15_1, count15_2, count15_3] = Attitude_Estimation_IECF(Acc_IMU_15, Gyro_IMU_15, Mag_cal_IMU_15);
...
if flag_IMU_16 == 1 % IMU 16 active
    % Obtain the sensor attitude estimation
    [q_e_b_CF_IMU_16, w_bias_IMU_16, norm_acc16, norm_mag16, error_mag16, error_acc16, count16_1, count16_2, count16_3] = Attitude_Estimation_IECF(Acc_IMU_16, Gyro_IMU_16, Mag_cal_IMU_16);
...
sgtitle('IMU Wrist Position Estimation')
title('Delta Elbow Angle'); ylabel('Degrees')
subplot(612)
plot(wristEPP(:,1))
