...
%     end
    ...
    % % Hard-coded calibration parameters for IMU 13 in Searle 11-561's table on 7/29/19
    A_acc_IMU_13 = [ 0.9944,   -0.0069,   -0.0039;
                     0.0093,    0.9981,    0.0246;
                     0.0022,   -0.0279,    0.9908 ];             
    b_acc_IMU_13 = [0.0153; -0.0005; -0.0448];
    
    % % Hard-coded calibration parameters for IMU 14 in Searle 11-561's table on 7/29/19
    A_acc_IMU_14 = [ 0.9940,   -0.0112,    0.0060;
                     0.0118,    0.9972,   -0.0206;
                    -0.0113,    0.0147,    0.9916 ];             
    b_acc_IMU_14 = [-0.0334; -0.0614; -0.0627];
    
    % % Hard-coded calibration parameters for IMU 15 in Searle 11-561's table on 7/29/19
    A_acc_IMU_15 = [ 0.9902,   -0.0211,   -0.0007;
                     0.0238,    0.9944,    0.0416;
                    -0.0057,   -0.0631,    0.9906 ];             
    b_acc_IMU_15 = [0.1538; -0.1792; -0.0475];
    
    % % Hard-coded calibration parameters for IMU 16 in Searle 11-561's table on 7/29/19
